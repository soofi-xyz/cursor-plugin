...
- [ ] Shared `/api/v2` authorization matches siblings (no extra JWT authorizer; Bearer verified in Lambda; ID token preferred, legacy session token still sent)
