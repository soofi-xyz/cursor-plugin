...
| <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/detail/720.png" alt="Hoopa" width="96"> | [`hoopa`](./agents/hoopa.md) | Portal delivery and maintenance orchestrator — defaults to incrementing an existing portal repo (shared API attach, Persist queries, existing CI) or creates a new portal when explicitly confirmed. | `/hoopa Update this portal backend and open a PR...` |
